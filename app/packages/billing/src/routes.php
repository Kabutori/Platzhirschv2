...
$r->middleware(['web','auth','system'])->prefix('api/v1/admin/billing')->group(function($r){
...
$r->middleware(['web','auth','tenant'])->prefix('api/v1/restaurant/billing')->group(function($r){
 $c=\App\Modules\Billing\Http\InvoiceController::class;
 $r->get('/',[$c,'customer']);
