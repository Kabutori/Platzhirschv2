...
class SystemOperationsTest extends TestCase {
 ...
 private function login(string $role='system_admin'): void {$this->actingAs(User::create(['name'=>'Admin','email'=>$role.'@example.test','password'=>'Correct-password-123','role'=>$role]));}
