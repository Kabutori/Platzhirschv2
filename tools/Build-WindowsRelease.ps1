...
$sources=@(
    ...
    @{name='mysql.msi';url='https://dev.mysql.com/get/Downloads/MySQL-8.4/mysql-8.4.11-winx64.msi';publisher='Oracle'},
...
foreach($item in $sources){
    ...
    Invoke-WebRequest -Uri $item.url -OutFile $path -TimeoutSec 600
