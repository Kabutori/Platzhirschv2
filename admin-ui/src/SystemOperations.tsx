...
export default function SystemOperations(){
 ...
 const running=q.data?.jobs.some(j=>['queued','running'].includes(j.status));const disabled=busy||Boolean(q.error)||!q.data?.available||Boolean(running);
